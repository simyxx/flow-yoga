...
<body <?php body_class('bg-white text-zinc-800 selection:bg-primary/20 selection:text-primary-dark'); ?>>
    ...
    <!-- TopNavBar -->
    <nav class="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 md:px-12 py-6 transition-all duration-300 bg-transparent"
        id="top-nav">
        <div class="flex items-center gap-3">
            ...
            if ($logo): ?>
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    <img alt="<?php bloginfo('name'); ?> Logo" class="h-16 w-auto object-contain"
